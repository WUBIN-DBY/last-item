...
<form method="post" action="" id="listform">
    ...
    <table class="table table-hover text-center">
      ...
      <tr>
           ...
           <a class="button border-main" href="YongHuServlet?method=getYonghuInfo&yonghudianhua=<%=y.getYonghudianhua()%>">
           <span class="icon-edit">
           </span> 修改</a> 
              <a class="button border-main" href="YongHuServlet?method=delete&yonghudianhua=<%=y.getYonghudianhua()%>">
