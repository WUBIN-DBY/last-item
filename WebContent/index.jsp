...
<div class="leftnav">
  ...
  <ul>
    <li><a href="YongHuServlet?method=listAll" target="right"><span class="icon-caret-right"></span>用户信息列表</a></li>
    <li><a href="YongHuServlet?method=add" target="right"><span class="icon-caret-right"></span>添加用户信息</a></li>
  </ul> 
